    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-zinc-950 max-w-lg mx-auto">
      ...
      <div className="px-4 py-3 border-b border-zinc-800 bg-zinc-900">
        <div className="relative">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500">
            ...
            {filtered.map(product => (
              ...
              >
                ...
                <div className="ml-3 text-right shrink-0">
                  <div className="text-sm font-semibold text-amber-400">{product.price.toFixed(2)} lei</div>
      ...
      {/* Add panel (shown when product selected) */}
      {selectedProduct && (
        <div className="border-t border-zinc-800 bg-zinc-900 p-4">
          <div className="flex items-center gap-3 mb-3">
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-zinc-100 truncate">{selectedProduct.name}</div>
